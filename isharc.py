...
This script assesses the overlap between duplex groups (DGs) generated by CRSSANT and uses it to filter the iSHARC dataset for further analysis.
"""
# Define version
__version__="1.0.0"
...
def parse_isharc(bam_file, gene_regions):
    ...
    coverage = set(generate_coverage())
    bam.close()
